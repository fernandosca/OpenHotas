...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=unchecked]:border-content-dim data-[state=unchecked]:bg-content-dim",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-4 w-4 rounded-full bg-content-primary shadow-sm ring-0 transition-transform",
